            ...
            <div className="grid">
                <div className="rounded-lg shadow-2xl bg-white lg:col-span-3 lg:p-6">
                    <form>
                        ...
                        <div className="relative z-0 w-full mb-6 group">
                            <input type="text" name="type_of_event" id="floating_repeat_password"
                                   className={` ${!isEditable ? 'cursor-not-allowed' : ''}
                                   block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer`}
                                   placeholder=" " required
                                   defaultValue={event.type_of_event}
                                   readOnly={!isEditable}
                                   onChange={handleChange}
                            />
                        ...
                        <div className="grid md:grid-cols-2 md:gap-6">
                            <div className="relative z-0 w-full mb-6 group">
                                <input type="text" name="date_propose" id="floating_first_name"
                                       className={`${!isEditable ? 'cursor-not-allowed' : ''}
                                       block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer`}
                                       placeholder=" " required
                                       defaultValue={event.date_proposed}
                                       readOnly={!isEditable}
                                       onChange={handleChange}
                                />
