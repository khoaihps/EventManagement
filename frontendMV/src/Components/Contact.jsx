...
const Contact = () => {
  return (
    <section
      id="contact"
      className="flex items-center bg-zinc-100 font-poppins"
    >
        ...
        <div className="flex flex-wrap mb-6">
          <div className="w-full px-4 mb-20 lg:w-1/3 lg:mb-0">
            <div className="relative h-full px-6 pt-20 pb-12 text-center shadow bg-gray-50">
              <div className="absolute top-0 inline-flex items-center justify-center w-20 h-20 text-yellow-600 transform -translate-x-1/2 -translate-y-1/2 bg-yellow-100 border border-yellow-600 rounded-full left-1/2 ">
                <svg
          ...
          <form action className="py-6 rounded shadow bg-gray-50">
            ...
            <div className="px-3 mb-6">
              ...
              <textarea
                ...
                required
                className="block w-full px-4 py-10 leading-tight text-gray-700 bg-gray-100 rounded "
                defaultValue={""}
              />
            </div>
            <div className="px-6">
